    ...
    return (
        <div>
            <ul className="subHeader">
                ...
                <li className="subHeaderListItem"> <i class="fa fa-tree" aria-hidden="true"></i> MILJÖVÄNLIGT</li>
                <li className="subHeaderListItem"> <i class="fa fa-star-o" aria-hidden="true"></i> NÖJDA KUNDER</li>
            </ul>
        </div>
    )
}
