...
export default ({ scene }) => {
    ...
    var spotLight_01 = new THREE.SpotLight(0xffffff, 1);
...
/*   lights[0].shadow.mapSize.x = 4096;
  lights[0].shadow.mapSize.y = 4096; */
/*   lights[1].shadow.mapSize.x = 4096;
  lights[1].shadow.mapSize.y = 4096;
  lights[2].shadow.mapSize.x = 4096;
  lights[2].shadow.mapSize.y = 4096; */
